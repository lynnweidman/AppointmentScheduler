...
public class UserUtil {
     ...
     *
     * @param appointmentID input of the appointment_Id
     * @return userName
     */
    public static ObservableList<UserModel> getUserByID(int appointmentID) throws SQLException {
        userByID.clear();
        ...
        while (rs.next()) {
            ...
            UserModel u = new UserModel(userName);
            userByID.add(u);
        }
        return userByID;
    }

    public static ObservableList<UserModel> getUserID(String userName, String password) throws SQLException {
        userID.clear();
